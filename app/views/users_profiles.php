  ...
  <div class="section-hero-c">
    <div class="container w-container">
      <div class="section-hero-c-container-a" data-ix="animate-on-load-b">
        ...
        <div class="section-hero-c-container-a-item-a">
          <div class="p-big">Monitor your user based and device based insights in simple visual reports. Get the user’s location, session, device and firmware versions easily. Understand your user’s behavior, retention rate, and detailed activity stream for their entire lifetime.</div>
        </div>
      </div>
      <div class="div-block-6">
        <div class="div-block-7"><img class="image-8" data-ix="animate-on-load-c" sizes="(max-width: 479px) 100vw, (max-width: 767px) 367px, (max-width: 991px) 441px, 808px" src="images/43x_1.png" srcset="images/43x_1-p-500.png 500w, images/43x_1-p-800.png 800w, images/43x_1-p-1080.png 1080w, images/43x_1-p-1600.png 1600w, images/43x_1-p-2000.png 2000w, images/43x_1.png 2454w">
        </div>
      </div>
    </div>
  </div>
  <div class="section-h">
    <div class="container w-container">
      <div class="container-p">
        <div class="container-p-box-a" data-ix="animate-on-scroll-a"><img class="image-3" sizes="(max-width: 479px) 100vw, (max-width: 767px) 390.90625px, (max-width: 991px) 41vw, 42vw" src="images/43x_2.png" srcset="images/43x_2-p-500.png 500w, images/43x_2-p-800.png 800w, images/43x_2-p-1080.png 1080w, images/43x_2-p-1600.png 1600w, images/43x_2.png 1863w">
        </div>
        <div class="container-p-box-b">
          <div class="container-p-box-b-item-a">
            <div class="icon-box-a" data-ix="animate-on-scroll-b"><img class="icon-pic-a" src="images/-13x_2.png">
            </div>
          </div>
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-c">
            <h2>Know every detail of your users</h2>
      ...
      <div class="container-p container-p-reverse">
        <div class="container-p-box-a" data-ix="animate-on-scroll-a"><img class="image-3" sizes="(max-width: 479px) 100vw, (max-width: 767px) 390.90625px, (max-width: 991px) 41vw, 42vw" src="images/63x.png" srcset="images/63x-p-500.png 500w, images/63x-p-800.png 800w, images/63x-p-1080.png 1080w, images/63x-p-1600.png 1600w, images/63x.png 1863w">
        </div>
        <div class="container-p-box-b">
          ...
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-c">
            <h2>Use data for driving customers actions</h2>
            <div class="div-block-23"></div>
          </div>
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-d">
