  ...
  <div class="section-hero-c" data-ix="animate-on-load-a">
    <div class="container w-container">
      ...
      <div class="div-block-6">
        <div class="div-block-7"><img class="image-8" data-ix="animate-on-load-c" sizes="(max-width: 479px) 100vw, (max-width: 767px) 193px, (max-width: 991px) 232px, 425px" src="images/-13x_1.png" srcset="images/-13x_1-p-500.png 500w, images/-13x_1-p-800.png 800w, images/-13x_1-p-1080.png 1080w, images/-13x_1.png 1494w">
        </div>
      </div>
    </div>
  </div>
  <div class="section-h">
    <div class="container w-container">
      <div class="container-p">
        <div class="container-p-box-a" data-ix="animate-on-scroll-a"><img class="image-3" sizes="(max-width: 479px) 100vw, (max-width: 767px) 270.640625px, (max-width: 991px) 41vw, 42vw" src="images/-33x_5.png" srcset="images/-33x_5-p-500.png 500w, images/-33x_5-p-800.png 800w, images/-33x_5-p-1080.png 1080w, images/-33x_5.png 1494w">
        </div>
        <div class="container-p-box-b">
          <div class="container-p-box-b-item-a">
            <div class="icon-box-a" data-ix="animate-on-scroll-b"><img class="icon-pic-a" src="images/1-Schedule3x.png">
            </div>
          </div>
          ...
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-d">
            <div>SMS are opened faster and more frequently than emails and this gives you opportunity to reach out to customers faster.</div>
          </div>
        </div>
      ...
      <div class="container-p container-p-reverse">
        <div class="container-p-box-a" data-ix="animate-on-scroll-a"><img class="image-3" sizes="(max-width: 479px) 100vw, (max-width: 767px) 270.640625px, (max-width: 991px) 41vw, 42vw" src="images/-3-copy3x.png" srcset="images/-3-copy3x-p-500.png 500w, images/-3-copy3x-p-800.png 800w, images/-3-copy3x-p-1080.png 1080w, images/-3-copy3x.png 1494w">
        </div>
        <div class="container-p-box-b">
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-b">
            <div class="icon-box-a"><img class="icon-pic-a" src="images/-1-ola3x.png">
            </div>
          </div>
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-c">
            <h2>Advanced message targeting</h2>
          </div>
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-d">
            <div>Create your segments and deliver time sensitive information to the users.</div>
          </div>
        </div>
        <div class="div-block-8">
          <div class="abstract-b"></div>
