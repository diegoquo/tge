  ...
  <div class="section-hero-c" data-ix="animate-on-load-a">
    <div class="container w-container">
      <div class="section-hero-c-container-a" data-ix="animate-on-load-b">
        ...
        <div class="section-hero-c-container-a-item-a">
          <div class="p-big">Use cohort analysis to easily compare how different groups of users behave over time in key product workflows such as user onboarding, registration, purchases, and app uninstalls.</div>
        </div>
      </div>
      <div class="div-block-6">
        <div class="div-block-7"><img class="image-8" data-ix="animate-on-load-c" sizes="(max-width: 479px) 100vw, (max-width: 767px) 363px, (max-width: 991px) 435px, 798px" src="images/33x.png" srcset="images/33x-p-500.png 500w, images/33x-p-800.png 800w, images/33x-p-1080.png 1080w, images/33x-p-1600.png 1600w, images/33x-p-2000.png 2000w, images/33x.png 2454w">
        </div>
      </div>
    </div>
  </div>
  <div class="section-h">
    <div class="container w-container">
      <div class="container-p">
        <div class="container-p-box-a" data-ix="animate-on-scroll-a"><img class="image-3" sizes="(max-width: 479px) 100vw, (max-width: 767px) 385.859375px, (max-width: 991px) 41vw, 42vw" src="images/43x_4.png" srcset="images/43x_4-p-500.png 500w, images/43x_4-p-800.png 800w, images/43x_4-p-1080.png 1080w, images/43x_4-p-1600.png 1600w, images/43x_4.png 1743w">
        </div>
        <div class="container-p-box-b">
          <div class="container-p-box-b-item-a">
            <div class="icon-box-a" data-ix="animate-on-scroll-b"><img class="icon-pic-a" src="images/1-3x_1.png">
            </div>
          </div>
          <div class="container-p-box-b-item-a" data-ix="animate-on-scroll-c">
            <h2>Track any relevant interaction with your app</h2>
          </div>
