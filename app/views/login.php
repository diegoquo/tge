...
<html data-wf-page="59331951be599a4a620b39ac" data-wf-site="5930669e1b4da30f46508724">
<head>
  <meta charset="utf-8">
  <title>Login | TapGage</title>
  <meta content="Login | TapGage" property="og:title">
...
<body>
  <div class="login-section-a">
    <div class="login-section-a-container-a" data-ix="animate-on-load-a">
      <div class="login-section-a-logo"><img class="login-section-a-logo-pic-a" src="images/13x.png">
      </div><img class="image-11" sizes="(max-width: 767px) 100vw, 35vw" src="images/login-34x3x.png" srcset="images/login-34x3x-p-500.png 500w, images/login-34x3x-p-800.png 800w, images/login-34x3x-p-1080.png 1080w, images/login-34x3x.png 1359w" width="450">
    ...
    <div class="login-section-a-container-b">
      <div class="login-container-b-box-a" data-ix="animate-on-load-b">
        ...
        <div class="login-container-box-a-item-a">
          ...
          </div><a class="button-a w-button" href="/sign-up">SignUp</a>
        </div>
      </div>
      <div class="login-section-a-container-b-box-a" data-ix="animate-on-load-c">
        <div class="login-section-a-item-b">
          <h2>Login to Tapgage</h2>
        </div>
        <div class="login-section-a-item-b">
        ...
        <div class="login-section-a-container-b-box-b">
          <div class="w-form">
            <form data-name="Email Form" id="email-form" name="email-form">
              ...
              <input class="form-text-field-a w-input" data-name="Name" id="name" maxlength="256" name="name" placeholder="Enter your name" type="text">
              <div class="div-block-20">
                <label class="field-label" for="email">Email Address:</label>
                <div>Forgot password?</div>
              </div>
              <input class="form-text-field-a form-text-field-a-variation-a w-input" data-name="Email" id="email" maxlength="256" name="email" placeholder="Enter your email address" required="required" type="email">
              <div class="login-section-form-item-a">
                <input class="button-c w-button" data-wait="Please wait..." type="submit" value="Login">
              </div>
            </form>
